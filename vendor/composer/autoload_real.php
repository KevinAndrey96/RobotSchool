...
class ComposerAutoloaderInit045ba9ac56bf43499b45004b1bd7c7d6
{
    ...
    public static function getLoader()
    {
        ...
        if ($useStaticLoader) {
            $includeFiles = Composer\Autoload\ComposerStaticInit045ba9ac56bf43499b45004b1bd7c7d6::$files;
        } else {
            $includeFiles = require __DIR__ . '/autoload_files.php';
        }
        foreach ($includeFiles as $fileIdentifier => $file) {
            composerRequire045ba9ac56bf43499b45004b1bd7c7d6($fileIdentifier, $file);
        }
...
function composerRequire045ba9ac56bf43499b45004b1bd7c7d6($fileIdentifier, $file)
{
