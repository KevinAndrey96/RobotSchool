    ...
    <div class="col-12 col-md-7 col-lg-6 auth-main-col text-center p-5">
        <div class="d-flex flex-column align-content-end">
            <div class="app-auth-body mx-auto">
                <div class="app-auth-branding mb-4"><img style="width:200px" class="logo-icon me-3" src="assets/images/robotschool-logo.png" alt="logo "></div>
                <h2 class="auth-heading text-center mb-5">Ingresar</h2>
                <div class="auth-form-container text-start">
                    <form class="auth-form login-form" method="POST" action="{{ route('login') }}">
                        @csrf
                        <div class="email mb-3">
                            <label class="sr-only" for="signin-email">Email</label>
                            <input id="signin-email" name="email" type="email"  class="form-control signin-email @error('email') is-invalid @enderror" placeholder="Correo electrónico" value="{{ old('email') }}" required="required" autocomplete="email" autofocus>
                            @error('email')
                    ...
                    <div class="auth-option text-center pt-5">¿No tienes cuenta? Registrate <a class="text-link" href="/register" >aquí</a>.</div>
