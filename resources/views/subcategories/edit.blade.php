    ...
    <div class="card">
        ...
        <div class="card-body">
            <form method="POST" action="/subcategories/update" enctype="multipart/form-data">
                ...
                <div style="margin-top:20px" class="form-group"><label for="description"><p style="font-weight:bold">Descripción:</p></label><textarea style="height: 100px;" class="form-control" name="description" id="description" required>{{$subcategory->description}}</textarea></div>
